...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Projects - nulad" },
    { name: "description", content: "Projects by nulad" },
  ];
}
    ...
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        <div className="border-3 border-black p-6 bg-white">
          ...
          <p className="mb-4">
            A prayer times application built with the Aurelia framework,
            displaying accurate Islamic prayer schedules.
          </p>
          <a
        ...
        <div className="border-3 border-black p-6 bg-white">
          ...
          <p className="mb-4">
            A portfolio showcase application for job candidates, demonstrating
        ...
        <div className="border-3 border-black p-6 bg-white">
          <h2>Compression</h2>
          <p className="mb-4">
            File compression and decompression utilities implementing various
            algorithms.
          </p>
          <a
      ...
      <div className="mt-12">
        <p>
          These projects have been archived from the main repository. View the
          complete archive at{" "}
          <a
